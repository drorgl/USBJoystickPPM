...
void RCState::button_changed(uint8_t but_id) {
	if ((button_state_change_time[but_id] > 100) && (button_state[but_id] == false)) {
		...
		case 1: camera_yaw = CENTER_VALUE;
			camera_pitch = CENTER_VALUE;
			break;
		case 6:auto_center = !auto_center;
		case 5: camera_mode = CAMERA_MODES::exponent; break;
		case 3: camera_mode = CAMERA_MODES::max_min; break;
		case 4: camera_mode = CAMERA_MODES::slow; break;
		}
